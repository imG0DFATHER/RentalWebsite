          ...
          <header className="mx-auto max-w-7xl px-2 sm:px-2 lg:px-8 ">
            <div className="flex h-16 ml-16 mr-16 items-center sticky top-0 z-50 justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    <Link to="/dashboard">
                      <button className="bg-gray-900 no-underline text-white hover:bg-blue-300/20 hover:text-white rounded-md px-3 py-2 text-sm font-light font-link">
                        Dashboard
                      </button>
                    </Link>
                    <button
                      onClick={handleClickScroll}
                      className="bg-gray-900 no-underline text-white hover:bg-blue-300/20 hover:text-white rounded-md px-3 py-2 text-sm font-light font-link"
                    >
                      Categories
                    </button>
              ...
              {/* <Link className="no-underline" to="/">
                <button className="ml-36 bg-gray-900 text-white/90 hover:bg-blue-300/30 flex flex-row rounded-md px-3 py-0 text-sm font-light font-link">
                  ...
                  <div className="ml-3 mr-1.5 my-2.5">Login or Sign up</div>
                </button>
              </Link> */}
                ...
                <Link to="/additem">
                  ...
                  >
                    <div className="flex flex-row">
                      ...
                      <span className="basis-3/4 font-link font-light">
                        Add
                      </span>
                    </div>
                  </button>
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            ...
                            className={classNames(
                              active ? "bg-gray-100" : "",
                              "block px-4 py-2 text-sm no-underline font-link text-gray-700"
                            )}
                          >
