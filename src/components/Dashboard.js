  ...
  return (
    <>
      ...
      {logindata.length === 0 ? (
        ...
        <>
          {/* <h1 className='font-link ml-16 mt-6'>Dashboard</h1> */}
          <h4 className="font-link ml-16 mt-6">Hey {logindata[0].name},</h4>
          ...
          <div className="bg-site-cream/50 shadow-inner py-6 pt-28 mt-4">
            ...
            <div className="w-60 h-0.5 bg-gradient-to-r from-site-blue to-sky-300 my-1 ml-20 border border-blue-300 rounded md:my-10 ">
            </div>
          ...
          <div className="relative bg-site-cream/50 flex items-center pb-16">
            ...
            >
              {data.map((item) => (
                <div
                  className={`rounded-sm border border-site-blue mx-3 inline-block p-4 w-[260px] h-[360px] cursor-pointer shadow-md bg-white`}
                // ${item.color}
                >
                  <img
                    className="w-[220px] inline-block p-2 cursor-pointer rounded-sm"
                    // hover:scale-105 ease-in-out duration-300
                    src={item.img}
                    alt="/"
                  />
                  <br />
                  <div className="font-link ml-2 mt-2 text-base font-medium">
                    ITEM NAME
                  </div>
                  <div className="flex flex-row ml-2 mt-3 mb-44 gap-3">
